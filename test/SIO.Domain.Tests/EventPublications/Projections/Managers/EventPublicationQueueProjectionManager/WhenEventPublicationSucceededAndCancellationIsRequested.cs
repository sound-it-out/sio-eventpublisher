...
{
    public sealed class WhenEventPublicationSucceededAndCancellationIsRequested : ProjectionManagerSpecification<EventPublicationQueue>
    {
        ...
        public WhenEventPublicationSucceededAndCancellationIsRequested(ITestOutputHelper testOutputHelper) : base(testOutputHelper)
        {
        }
